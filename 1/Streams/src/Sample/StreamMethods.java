...
public class StreamMethods {
	...
	public static void main(String[] args) {
		...
		Object arr2[] = new Object[10];//declaring array size and this array size is the final array size on which the list elements will come.
		Object a[] = list2.toArray(arr2); //If the array size is less then in the runtime new array will be created.
		for (Object val: a) {
			System.out.println(val);
		}
